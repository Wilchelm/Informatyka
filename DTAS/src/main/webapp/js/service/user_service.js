...
angular.module('dtas').factory('UserService', ['$http', '$q', function($http, $q){
    ...
    var REST_SERVICE_URI = 'http://localhost:8080/v1/user';
    ...
    function fetchActiveUser() {
        var deferred = $q.defer();
        $http.get(REST_SERVICE_URI+"/active")
            .then(
                function (response) {
                    deferred.resolve(response.data);
                },
    ...
    {
        var deferred = $q.defer();
        $http.get("http://localhost:8080/v1/login?name="+name+"&password="+password)
            .then(
                function (response) {
                    deferred.resolve(response.data);
                },
    ...
    {
        var deferred = $q.defer();
        $http.get("http://localhost:8080/v1/logout")
            .then(
                function (response) {
                    deferred.resolve(response.data);
                },
